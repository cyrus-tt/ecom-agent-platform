 ...
 * depends on `dispatchModule.isEnabled()`, which reads
 * `process.env.DISPATCH_AGENT_ENABLED`. Tests that need to flip the dispatch
 * flag MUST stub the env var BEFORE the first `require("./lib/auth/permissions")`
